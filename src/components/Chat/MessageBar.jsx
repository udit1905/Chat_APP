...
function MessageBar() { 
 ...
 useEffect(() => {
  ...
  return <div className="bg-panel-header-background h-20 px-4 gap-6 realtive flex items-center">
    <>
      <div className="flex gap-6">
          ...
          {showEmojiPicker && (
          <div className="absolute bottom-24 left-120 z-40"
            ref={emojiPickerRef}
          >
            <EmojiPicker onEmojiClick={handleEmojiClick} theme="dark"/>
            </div>
            )}
          <ImAttachment className="text-panel-header-icon cursor-pointer text-xl" title="Attach files" onClick={()=>setGrabPhoto(true)}/>
      </div>
