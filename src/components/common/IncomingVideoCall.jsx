...
function IncomingVideoCall() {
  ...
  const acceptCall = () => {
    ...
    socket.current.emit("accept-incoming-video-call", {
  ...
  return (
    <div className="h-24 w-80 fixed bottom-8 rounded-sm mb-0 right-6 z-50 flex gap-5 items-center justify-start p-4 bg-conversation-panel-background text-white drop-shadow-2xl border-icon-green border-2 py-14">
      <div>
        <Image
